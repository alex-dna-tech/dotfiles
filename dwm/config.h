...
static const char dmenufont[]       = "FiraCode Nerd Font Mono:size=14:style=Bold";
static const char col_gray1[]       = "#282822"; /* gruvbox bg dark */
static const char col_gray2[]       = "#3c3836"; /* gruvbox bg1 */
static const char col_gray3[]       = "#ebdbb2"; /* gruvbox fg */
static const char col_gray4[]       = "#fbf1c7"; /* gruvbox fg bright */
static const char col_cyan[]        = "#d65d0e"; /* gruvbox orange */
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-bw", "5", "-g", "2", "-l", "6", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_p,      spawn,          {.v = picom_on } },
	{ MODKEY|ShiftMask,             XK_p,      spawn,          {.v = picom_off } },
